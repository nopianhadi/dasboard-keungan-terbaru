...
const Packages = Loadable(lazy(() => import('../views/apps/packages/Packages')));
const Clients = Loadable(lazy(() => import('../views/apps/clients/Clients')));
const Finance = Loadable(lazy(() => import('../views/apps/finance/Finance')));
const Team = Loadable(lazy(() => import('../views/apps/team/Team')));
...
const Router = [
  {
    ...
    children: [
      ...
      { path: '/apps/packages', element: <Packages /> },
      { path: '/apps/clients', element: <Clients /> },
      { path: '/apps/finance', element: <Finance /> },
      { path: '/apps/team', element: <Team /> },
